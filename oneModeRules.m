...
load carData; %loads file from folder
x = displacement;
y = horsepower;
z = mpg;
w = weight;
...
%% Questions
disp (string ( 'The model for 3rd order was the best as each variable was accounted for. Also need be any extra variables can be set to 0 to act like a lower order operation.'));
